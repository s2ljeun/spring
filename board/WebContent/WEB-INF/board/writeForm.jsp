...
<body>
<div align="center">
	<form name="f" action="write_board.do" method="post" onsubmit="return checkBoard()" enctype="multipart/form-data">
		...
		<table border="1" width="500">
			...
			<tr>
				<th bgcolor="yellow">파 일</th>
				<td>
					<input type="file" name="filename" class="box" size="50">
				</td>
			</tr>
			<tr>
